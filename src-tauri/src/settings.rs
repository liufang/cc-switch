...
impl VisibleApps {
    ...
    pub fn is_visible(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::SohoCode => self.sohocode,
        }
    }
}
...
pub struct AppSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sohocode_config_dir: Option<String>,
    ...
    /// 当前 SohoCode 供应商 ID（本地存储，保持结构一致）
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub current_provider_sohocode: Option<String>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            current_provider_sohocode: None,
...
pub fn get_sohocode_override_dir() -> Option<PathBuf> {
    let settings = settings_store().read().ok()?;
    settings
        .sohocode_config_dir
        .as_ref()
...
pub fn get_current_provider(app_type: &AppType) -> Option<String> {
    ...
    match app_type {
        ...
        AppType::SohoCode => settings.current_provider_sohocode.clone(),
    }
}
...
pub fn set_current_provider(app_type: &AppType, id: Option<&str>) -> Result<(), AppError> {
    ...
    mutate_settings(|settings| match app_type {
        ...
        AppType::SohoCode => settings.current_provider_sohocode = id_owned.clone(),
    })
}
